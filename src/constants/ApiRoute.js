...
export const API_ROUTE = {
  ...
  HISTORICAL_DATA: `${API_ROOT}/data/2.5/onecall?lat=@lat&lon=@lon&appid=${API_KEY}`, //https://openweathermap.org/api/one-call-api
  ICONS : `${API_ROOT}/img/wn/`, //https://openweathermap.org/weather-conditions
